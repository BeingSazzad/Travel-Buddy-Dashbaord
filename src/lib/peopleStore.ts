...
const store = createStore<Member>(PEOPLE_STORAGE_KEY, [
  ...
  { id: 'u4', name: 'Maya Chen', email: 'maya@seluna.app', city: 'Singapore', country: 'Singapore', status: 'active', subscription: 'cancelled', verified: true, trips: 4, joined: '2026-01-09' },
